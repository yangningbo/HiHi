...
public class EmotionMap {
    ...
    private Map<String, String> general1 = new LinkedHashMap<String, String>();
    private Map<String, String> general2 = new LinkedHashMap<String, String>();
    private Map<String, String> generalAll = new LinkedHashMap<String, String>();
    ...
    private EmotionMap() {
        ...
        general.put("[删除]", "del_btn_nor.png");
        
        general1.put("[懒得理你]", "ldln_org.png");
        general1.put("[思考]", "sk_org.png");
        general1.put("[怒骂]", "nm_org.png");
        general1.put("[哈哈]", "laugh.png");
        general1.put("[抓狂]", "crazya_org.png");
        general1.put("[抱抱]", "bba_org.png");
        general1.put("[爱你]", "lovea_org.png");
        general1.put("[鼓掌]", "gza_org.png");
        general1.put("[悲伤]", "bs_org.png");
        general1.put("[嘘]", "x_org.png");
        general1.put("[呵呵]", "smilea_org.png");
        general1.put("[感冒]", "gm.png");
        general1.put("[黑线]", "hx.png");
        general1.put("[愤怒]", "face335.png");
        general1.put("[失望]", "face032.png");
        general1.put("[做鬼脸]", "face290.png");
        general1.put("[阴险]", "face105.png");
        general1.put("[困]", "face059.png");
        general1.put("[拜拜]", "face062.png");
        general1.put("[疑问]", "face055.png");
        general1.put("[赞]", "face329.png");
        general1.put("[心]", "hearta_org.png");
        general1.put("[伤心]", "unheart.png");
        general1.put("[囧]", "j_org.png");
        general1.put("[奥特曼]", "otm_org.png");
        general1.put("[蜡烛]", "lazu_org.png");
        general1.put("[蛋糕]", "cake.png");
        general1.put("[删除]", "del_btn_nor.png");
        
        general2.put("[弱]", "sad_org.png");
        general2.put("[ok]", "ok_org.png");
        general2.put("[威武]", "vw_org.png");
        general2.put("[猪头]", "face281.png");
        general2.put("[月亮]", "face18.png");
        general2.put("[浮云]", "face229.png");
        general2.put("[咖啡]", "face74.png");
        general2.put("[爱心传递]", "face221.png");
        general2.put("[来]", "face277.png");
        general2.put("[熊猫]", "face002.png");
        general2.put("[帅]", "face94.png");
        general2.put("[不要]", "face274.png");
        general2.put("[熊猫]", "face002.png");
        general2.put("[删除]", "del_btn_nor.png");
        
        generalAll.putAll(general);
        generalAll.putAll(general1);
        generalAll.putAll(general2);
...
//        huahua.put("[霹雳]", "lxh_pili.png");
    ...
    public String[] getNames() {
    	return general.keySet().toArray(new String[general.size()]);
    }
    ...
    public Map<String, String> getGeneral1() {
    	return general1;
    }
    public Map<String, String> getGeneral2() {
    	return general2;
    }
    public Map<String, String> getGeneralAll() {
    	return generalAll;
    }

...
package com.gaopai.guiren.support.zxing.camera;
  ...
  private static Class<?> maybeForName(String name) {
    try {
      ...
      return null;
    	...
    	Log.d(TAG, "Unexpected error while finding class " + name, re);
      return null;
    }
  }
  ...
  private static Method maybeGetMethod(Class<?> clazz, String name, Class<?>... argClasses) {
    try {
      ...
      return null;
    	...
    	Log.d(TAG, "Unexpected error while finding method " + name, re);
      return null;
    }
  }
  ...
  private static Object invoke(Method method, Object instance, Object... args) {
    try {
      return method.invoke(instance, args);
    	...
    	Log.d(TAG, "Unexpected error while invoking " + method, e);
      return null;
    } catch (InvocationTargetException e) {
    	Log.d(TAG, "Unexpected error while invoking " + method, e.getCause());
      return null;
    } catch (RuntimeException re) {
    	Log.d(TAG, "Unexpected error while invoking " + method, re);
    	return null;
    }
  }

...
public class NewMessageTable {
	...
	public NewMessageTable(SQLiteDatabase sqlLiteDatabase) {
	...
	public static String getCreateTableSQLString() {
		if (null == mSQLCreateWeiboInfoTable) {
			...
			columnNameAndType.put(COLUMN_CARD_ID, COLUMN_TEXT_TYPE);
			columnNameAndType.put(COLUMN_DESC, COLUMN_TEXT_TYPE);

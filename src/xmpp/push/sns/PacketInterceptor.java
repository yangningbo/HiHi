 ...
 * together with a {@link com.xmpp.push.sns.filter.PacketFilter} so that only
 ...
 *
 * @see Connection#addPacketInterceptor(PacketInterceptor, com.xmpp.push.sns.filter.PacketFilter)

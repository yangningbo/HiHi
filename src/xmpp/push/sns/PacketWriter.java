...
class PacketWriter {
    ...
    */ 
    protected void init() {
        ...
        writerThread.setName("Liaos Packet Writer (" + connection.connectionCounterValue + ")");
    ...
    public void sendPacket(Packet packet) {
        if (!done) {
        	...
        	//Log.e("PacketWriter", packet.getXmlns());
    ...
    void startKeepAliveProcess() {
        ...
        if (keepAliveInterval > 0) {
            ...
            keepAliveThread.setName("Liaos Keep Alive (" + connection.connectionCounterValue + ")");
